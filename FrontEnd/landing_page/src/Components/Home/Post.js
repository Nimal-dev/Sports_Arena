...
function Post() {
  ...
  return (
    ...
    <Header/>
      <ToastContainer />
      <div className="row">
        <div className="col-8 bg_pattern p-0"  style={{marginTop:"150px"}}>
        ...
        <div className="col-4 border-start py-4 px-4 bg-light" style={{marginTop:"150px"}}>
          <div className="row">
            <div className="col">
              ...
              <div className="card p-3 -h-100 overflow-hidden text-white bg-white rounded-4 shadow-lg">
                <div className="mb-2">
                  <div className="d-flex gap-2">
                    <img
                      src={`http://127.0.0.1:8000/public/image/${auth.image}`}
                      style={{
                        width: "50px",
                        height: "50px",
                        borderRadius: "50%",
