...
class PostController extends Controller
{
    ...
    //         // Insert into the socialmedia table using the userId from users table
    ...
    public function viewpost(){
        $data = DB::table('post')
            ->join('socialmedia', 'post.user_id', '=', 'socialmedia.userid')
            ->select(
                'post.id as post_id',
                ...
                'socialmedia.name',
                'socialmedia.dob',
                'socialmedia.image as user_image',
                'socialmedia.userid'
            )
            ->get();
...
{
    $data = DB::table('users')
        ->join('socialmedia', 'users.id', '=', 'socialmedia.userid')
    ...
    public function viewComment(Request $request){
        ...
        $comment = DB::table('comment')
            ->where('postid', $postid)
            ->join('socialmedia', 'comment.userid', '=', 'socialmedia.userid')
            ->get();
